{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c021a4e9-368a-44e8-af51-96c8575c9be6",
          "type": "basic.input",
          "data": {
            "name": "btn",
            "range": "[1:0]",
        ...
        {
          "id": "dc72bdab-3c2f-4f8f-bc14-11efbbc7c438",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[1:0]",
        ...
        {
          "id": "dcd27bad-e2b3-4287-8cf3-35e185da531a",
          "type": "basic.input",
          "data": {
            "name": "btn",
            "range": "[1:0]",
        ...
        {
          "id": "c52c19d4-8f91-4e69-80cc-e404ee5177f7",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "### Testing buttons SW1 and SW2 on LEDs 1 and 2 (Positive logics)",
            "readonly": true
          },
          "position": {
            "x": 64,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Nandland Go Board: LEDs and Buttons test\n\nThe state of the buttons is shown on the LED",
            "readonly": true
          },
          "position": {
            "x": 24,
        ...
        {
          "id": "fabf0109-2c48-412f-9c8b-a4b61e020445",
          "type": "basic.info",
          "data": {
            "info": "### Testing buttons SW3 and SW4 on LEDs 3 and 4 (Negative logic)",
            "readonly": true
          },
          "position": {
            "x": 664,
        ...
        {
          "id": "60f75d46-df79-41c7-b9c7-e9d156aaef22",
      ...
      "wires": [
        {
          "source": {
            "block": "c021a4e9-368a-44e8-af51-96c8575c9be6",
            "port": "out"
          },
          "target": {
            "block": "dc72bdab-3c2f-4f8f-bc14-11efbbc7c438",
            "port": "in"
          },
          "size": 2
        },
        {
          "source": {
            "block": "dcd27bad-e2b3-4287-8cf3-35e185da531a",
            "port": "out"
          },
          "target": {
            "block": "60f75d46-df79-41c7-b9c7-e9d156aaef22",
        ...
        },
        {
          ...
          "target": {
            "block": "c52c19d4-8f91-4e69-80cc-e404ee5177f7",
            "port": "in"
          },
          "size": 2
        }
