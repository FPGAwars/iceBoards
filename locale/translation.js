...
gettext('ICE40UP-Breakout-board');
gettext('Icebreaker');
gettext('Icestick');
...
gettext('02-jumping-LED');
gettext('01-LEDs-buttons');
gettext('### Turn on RGB LED');
gettext('# Fomu: RGB Test\n\nTesting the RGB LED');
gettext('Turn on GREEN color (Negative logic)');
gettext('02-jumping-LED');
...
gettext('03-riscv-stop-watch');
gettext('01-LEDs-buttons');
gettext('# ICE40UP-Breakout board: RGB Test\n\nTesting the RGB LED');
gettext('Turn on RED color (Negative logic)');
gettext('02-jumping-LED');
gettext('# ICE40UP Breakout Board: JUMPING LED\n\nA jumping particle is shown on the RGB LED');
gettext('03-riscv-stop-watch');
gettext('## ICE40UP Breakout board: RISC-V stopwatch on LEDs');
gettext('## Buttons\nNo buttons on the Ice40UP Breakout board');
gettext('01-LEDs-buttons');
gettext('02-jumping-LED');
gettext('03-riscv-stop-watch');
gettext('01-LEDs-buttons');
gettext('# Icebreaker: LEDs and Buttons test\n\nTesting the LEDs and buttons');
gettext('02-jumping-LED');
gettext('# Icebreaker: JUMPING LED\n\nWhen the button is pressed a particle moves up and down,   \nsimulating a jump (with gravity). The particle is shown  \non the LEDs');
gettext('03-riscv-stop-watch');
gettext('## Icebreaker: RISC-V stopwatch on LEDs');
gettext('01-LEDs-buttons');
gettext('02-jumping-LED');
gettext('03-riscv-stop-watch');
gettext('01-LEDs');
...
gettext('02-jumping-LED');
gettext('01-LEDs-buttons');
gettext('# Icesugar-1.5: RGB Test\n\nTesting the RGB LED');
gettext('02-jumping-LED');
gettext('# Icesugar-1.5: JUMPING LED\n\nA jumping particle is shown on the RGB LED');
gettext('03-riscv-stop-watch');
gettext('## Icesugar-1.5: RISC-V stopwatch on LEDs');
...
gettext('03-riscv-stop-watch');
gettext('01-LEDs-buttons');
gettext('# Radiona ULX3S-12F: LEDs and Buttons test\n\nTesting the LEDs and buttons');
gettext('1-bit constant');
gettext('Output pin');
gettext('wifi_gpio0 should be 0 if wifi  \nis not used');
gettext('02-jumping-LED');
gettext('# Radiona ULX3S-12F: JUMPING LED\n\nWhen the button is pressed a particle moves left and right,   \nsimulating a jump (with gravity). The particle is shown  \non the LEDs');
gettext('03-riscv-stop-watch');
gettext('## Radiona ULX3S-12F: RISC-V stopwatch on LEDs');
gettext('01-LEDs-buttons');
gettext('02-jumping-LED');
gettext('03-riscv-stop-watch');
gettext('01-LED-ON');
gettext('### Turn on LED');
gettext('# TinyFPGA-BX: LED test\n');
gettext('02-jumping-LED');
gettext('# TinyFPGA-BX: JUMPING LED\n\nA jumping particle is shown on the LEDs. It is shown only in one LED  \n(but external leds can be added)');
gettext('03-riscv-stop-watch');
gettext('## TinyFPGA-BX: RISC-V stopwatch on LEDs');
